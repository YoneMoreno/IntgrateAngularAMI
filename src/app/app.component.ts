...
// instantiate the loader
  loader = new AMI.VolumeLoader(this.container);

  t2 = ['36444280', '36444294', '36444308', '36444322', '36444336'];
  files = this.t2.map(function(v) {
...
.then(function() {
    // merge files into clean series/stack/frame structure
     var series = this.loader.data[0].mergeSeries(this.loader.data);
    this.loader.free();
    this.loader = null;
    ...
    for (var mySeries of series) {
      ...
      this.container.appendChild(seriesDiv);
